...
<span className="bg-danger text-white px-4 py-2 rounded-pill shadow-sm fw-semibold">Principal Login</span>
</h2>
...
<button className="btn bg-danger" onClick={handleLogin}>Login</button>
</div>
);
}
...
<span className="bg-danger text-white px-4 py-2 rounded-pill shadow-sm fw-semibold"> Principal Dashboard</span></h3>
...
<Link className="btn btn-success w-100 p-3" to="/teachersignup">Teachers signup here</Link>
</div>

<Link to="/AdmissionsAdmin" className="btn btn-info">Manage Admissions</Link>

<div className="row g-4 mt-3">
<div className="col-md-4">
<div  className="card bg-warning p-3" onClick={() => navigate("/studentdashboard")}>
...
<p className="text-danger">{msg.message}</p>
      ...
      {/* DELETE BUTTON */}
<button className="text-white btn btn-primary" onClick={() => deleteMessage(msg.id)}>Delete</button>
