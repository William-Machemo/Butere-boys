...
<p className="mb-4">Explore all sports activities at Butere Boys High School. Click view to learn more.</p>

<div className="row">{sportsData.map((Sports, idx) => (
<div className="col-md-4 mb-4" key={idx}>
<div className="card shadow-sm h-100">

<img src={`/images/${Sports.img}`} className="card-img-top" alt={Sports.title}
style={{ height: "200px", objectFit: "cover" }}/>

<div className="card-body">
<h5 className="card-title text-success">{Sports.title}</h5>

<p className="card-text">{Sports.description}</p>

<Link to={Sports.link} className="btn btn-success w-100" >View {Sports.title}
</Link>
</div>
