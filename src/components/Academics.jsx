...
function Academics() {
  ...
  <img src="images/kcse.jpg" alt="KCSE Results" className="img-fluid rounded mt-3" style={{
  width: "100%",
  maxHeight: "180px",
  objectFit: "cover"
  }}
  ...
  onClick={() => setSelectedImage("images/kcse.jpg")}>Click to View </button>
  </div>
  </div>
  </section>
  ...
  <p>The school has introduced opening exams for all students to assess
  their readiness after holidays.</p>
  ...
  <div style={{ position: "relative" }}>
  <img  src="images/kcse.jpg" alt="Grade 10 Exam" className="img-fluid rounded"
  style={{
  width: "100%",
  height: "150px",
  objectFit: "cover"
  ...
  <div className="col-md-4 col-12 mb-3">
  <div style={{ position: "relative" }}>
  <img src="images/form3-exam.jpg" alt="Form 3 Exam" className="img-fluid rounded"
  style={{
  width: "100%",
  height: "150px",
  objectFit: "cover"
  ...
  onClick={() => setSelectedImage("images/form3-exam.jpg")}>Click to View
</button>
  </div>
  ...
  <div className="col-md-4 col-12 mb-3">
  <div style={{ position: "relative" }}>
  <img src="images/kcse.jpg" alt="Form 4 Exam Timetable"
  ...
  <p>Students actively participate in various academic competitions to
  sharpen their skills and gain exposure.</p>
  <ul>
