...
const AdmissionsAdmin = () => {
  ...
  // ✅ FIXED FILE HANDLER (Cloudinary + local safe)
  const getFile = (path) => {
    if (!path) return "";
  ...
  // ✅ FIXED DOWNLOAD (CLOUDINARY SAFE)
        ...
        <div className="modal d-block" style={{ background: "#0008" }}>
          <div className="modal-dialog modal-lg">
            <div className="modal-content p-3">
              ...
              <p><b>Note:</b> {selectedApp.notes}</p>
                    ...
                    (isPDF(selectedApp.birth_certificate) ? (
                      <div>
                        ...
                        <button
                          ...
                          onClick={() =>
                            downloadFile(selectedApp.birth_certificate)
                          }
                        >
                          Download
                        </button>
                      ...
                      <img
                        ...
                        onClick={() =>
                          setZoomImage(getFile(selectedApp.birth_certificate))
                        }
                        alt=""
                      />
                    ))}
                    ...
                    (isPDF(selectedApp.results_slip) ? (
                      <div>
                        ...
                        <button
                          className="btn btn-sm btn-secondary ms-2"
                          onClick={() =>
                            downloadFile(selectedApp.results_slip)
                          }
                        >
                          Download
                        </button>
                      ...
                      <img
                        ...
                        className="img-fluid rounded"
                        onClick={() =>
                          setZoomImage(getFile(selectedApp.results_slip))
                        }
                        alt=""
                      />
                    ))}
                ...
                <div className="col-md-4">
                  ...
                  {selectedApp.passport_photo ? (
                    <img
                      ...
                      className="img-fluid rounded"
                      onClick={() =>
                        setZoomImage(getFile(selectedApp.passport_photo))
                      }
                      alt=""
                    />
                  ) : (
              ...
              <div className="d-flex gap-2 mt-2">
                <button
                  ...
                  onClick={() =>
                    sendDecision(selectedApp.id, "Accepted")
                  }
                >
                  Approve
                </button>
                ...
                <button
                  ...
                  onClick={() =>
                    sendDecision(selectedApp.id, "Rejected")
                  }
                >
                  Reject
                </button>
