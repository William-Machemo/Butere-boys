...
<img src="images/Ghorofa.jpg" alt="slide1" className="d-block w-100 img-fluid"
style={{ height: "300px", objectFit: "cover" }}/>
</div>

<div className="carousel-item">
<img src="images/Ghorofa4.jpg" alt="slide2" className="d-block w-100 img-fluid"
 style={{ height: "300px", objectFit: "cover" }} />
</div>

<div className="carousel-item">
<img src="images/News4.jpg" alt="slide3" className="d-block w-100 img-fluid"
style={{ height: "300px", objectFit: "cover" }} />
</div>

<div className="carousel-item">
<img src="images/Gate.jpg" alt="slide4" className="d-block w-100 img-fluid"
style={{ height: "300px", objectFit: "cover" }} />
</div>
...
<h1 className="fw-bold mt-3">View Our Sports Activities</h1>
...
<Link  to="/Sports"  className="btn btn-danger me-2"
style={{ whiteSpace: "nowrap", fontSize: "14px", padding: "5px 9px" }} > Explore Sports</Link>
<br />
<Link  to="/Curriculum" className="btn btn-danger"
style={{ whiteSpace: "nowrap", fontSize: "14px", padding: "5px 9px" }} > Explore Academics</Link>
...
<div className="d-flex flex-column flex-md-row align-items-center">
      ...
      {/* Principal Image */}
<img src="images/principal.pg.jpg"   alt="Principal" className="principal-img me-md-3 mb-3 mb-md-0"/>

      {/* Text Content */}
<div>
<h5 className="text-center text-danger">HABIL MALIKA</h5>
<h5 className="fw-bold text-center text-md-start">Chief Principal's Message
</h5>
<p className="text-center text-md-start mb-0"> We nurture academic excellence and strong moral values to prepare students for future success. </p>
</div>
...
<img src="images/muhati.jpg"   alt="Deputy Principal" className="principal-img me-md-3 mb-3 mb-md-0"/>

      {/* Text Content */}
<div>
<h5 className="text-danger">Mr. Wanzetse</h5>
<h5 className="fw-bold text-center text-md-start">Deputy Principal (Academics)
</h5>
...
<h3 className="text-center">
  <span className="bg-danger text-white px-4 py-2 rounded-pill shadow-sm fw-semibold">Cultural Day </span></h3>
...
<div
className="video-overlay" onClick={(e) => {
...
<iframe src="https://www.youtube.com/embed/iWHuX_8WwIU"
title="Talent Day"
allow="autoplay; encrypted-media"
allowFullScreen></iframe>
...
{/*   iframe is a html tag that allows a website to be embedded into another website */}
<iframe src="https://www.youtube.com/embed/leQLTGOUaEc"
...
allowFullScreen></iframe>
      ...
      {/* HERO SECTION */}
<div className="text-white d-flex align-items-center justify-content-center text-center mb-4 flex-wrap overflow-hidden" style={{
...
<img src={`images/${img}`} className="d-block w-100 rounded img-fluid"
...
<h3 className="text-center">
<span className="bg-danger text-white px-4 py-2 rounded-pill shadow-sm fw-semibold"> View Sports Activities</span>
</h3>
<br />
...
<h5 className="fw-bold text-center text-md-start">
 Deputy Principal (Academics) </h5>

<p className="text-center text-md-start mb-0">Butere Boys is
a leading institution dedicated to empowering young students through
quality education, discipline, and leadership development.</p>
</div>
...
<h3 className="text-center">
<span className="bg-danger text-white px-4 py-2 rounded-pill shadow-sm fw-semibold">View top Pages</span>
</h3>
<br />
<div className="marquee-container">
<div className="marquee-content d-inline-flex gap-3 px-3">
...
<Link className="btn btn-success px-3" to="/Admissions">Admission</Link>
<Link className="btn btn-success px-3" to="/SchoolVideos">Videos</Link>
<Link className="btn btn-success px-3" to="/academics">Academics</Link>
<Link className="btn btn-success px-3" to="/StudentLife">Student Life</Link>
<Link className="btn btn-success px-3" to="/Alumni">Alumni</Link>
<Link className="btn btn-success px-3" to="/Sports">Sports</Link>
...
<img src={`/images/${news.img}`} className="card-img-top"
alt={`news${idx + 1}`} style={{ height: "200px", objectFit: "cover" }}/>
<div className="card-body">
...
<section className="container my-5">
<h3 className="text-center">
<span className="bg-danger text-white px-4 py-2 rounded-pill shadow-sm fw-semibold">School Videos</span>
</h3>
<div className="row g-4">
...
<iframe  src="https://www.youtube.com/embed/suE0g_SpaoM"
title="Candidates Dedication Service"
allow="autoplay; encrypted-media"
allowFullScreen
          ></iframe>
...
<iframe src="https://www.youtube.com/embed/IbpM7KaVDFg"
